...
\engl{bounding box}. Za svaki omeđujući pravokutnik poznate su sljedeće
informacije:
...
vrijednosti \engl{value} $A_v$ proporcionalna prosječnoj udaljenosti koju svi
...
Formalno, točnost ili dobrota \engl{fitness} sustava određena je izrazom:
...
fontom konstantne širine \engl{monospaced font}, i to se iskorištava algoritam
...
\kljucnerijeci{sustav za određivanje strukture teksta, optičko raspoznavanje
